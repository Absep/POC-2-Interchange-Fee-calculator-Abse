    ...
    <div className="w-screen h-screen bg-[#030712] text-[#F3F4F6] flex overflow-hidden font-sans select-none antialiased">
      ...
      <main className="w-[70%] h-full p-6 overflow-y-auto flex flex-col gap-6 border-r border-[#1F2937] shrink-0">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <div className="bg-[#0B1117] border border-[#1F2937] p-5 rounded-lg flex flex-col justify-between backdrop-blur-md">
            <div>
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <div className="bg-[#030712] p-3 rounded border border-[#1F2937]">
                    ...
                    <span className="text-lg font-bold text-white font-mono">
                      {calculationResult?.estimated_monthly_fees.toLocaleString()} {calculationResult?.currency}
                    </span>
                  </div>
                  <div className="bg-[#030712] p-3 rounded border border-[#1F2937]">
            ...
            <div className="mt-4 pt-4 border-t border-[#1F2937] bg-gradient-to-r from-[#030712] to-transparent p-3 rounded border border-dashed border-[#1F2937]">
              ...
              <p className="text-xs text-gray-300 mt-1 leading-relaxed">
                Deploying custom routing protocols optimizes baseline execution charges to <strong className="text-[#38BDF8]">{calculationResult?.optimized_rate_pct}</strong>, reducing costs by <strong className="text-emerald-400">{calculationResult?.potential_savings.toLocaleString()} {calculationResult?.currency}/mo</strong>.
              </p>
            </div>
          </div>
        </div>
      ...
      <aside className="w-[30%] h-full bg-[#0B1117] p-6 flex flex-col justify-between border-l border-[#1F2937] shrink-0 overflow-y-auto">
        <div className="flex flex-col gap-6">
          ...
          <div className="border-t border-[#1F2937] pt-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed mt-1.5 font-sans">
              Interchange fees dictate the baseline financial viability of modern merchant enterprises[cite: 49]. This system helps founders, SMB operators, and capital allocators map processing friction across different card networks, payment channels, and regulatory ceilings[cite: 49].
            </p>
          </div>
          ...
          <div className="border-t border-[#1F2937] pt-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed mt-1.5 font-sans">
              Regulated heavily by central banking authorities (such as the ECB and Federal Reserve) alongside private card networks (Visa/Mastercard) who manage interchange ceilings and routing rulebooks globally[cite: 50].
            </p>
          </div>
        ...
        {/* Section E: Primary Actions Layer for Downloading Sample Data */}
